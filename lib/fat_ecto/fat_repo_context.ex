defmodule FatEcto.RepoContext do
  @moduledoc false
  ...
  defmacro __using__(options) do
    quote location: :keep do
      ...
      # TODO: add count and count!
      # TODO: accept count_by as option
      def count(schema) do
      ...
      """
      # TODO: accept count_by as option. make above and this method a one function only
      ...
      """
      # TODO: use Context.get here with options
      # TODO: also accept limit and order_by options
      ...
      """
      # TODO: merge create_by and create. changeset_fn should be passed as params
      ...
      @doc """
        Create a record by passing schema and attributes to a changeset. It will return the record created.
      """
      # TODO: merge create! and create_by!
      def create!(schema, attrs, opts \\ []) do
        schema.__struct__
        |> schema.changeset(attrs)
        |> @repo.insert!(opts)
      ...
      """
      # TODO: merge update_by and update
      ...
      @doc """
        Delete the record.
      """
      # TODO: add delete! and fix delete to return tuple
      def delete(item) do
        @repo.delete(item)
      end
      ...
      """
      # TODO: return success/failure tuple
      ...
      """
      # TODO: accept custom changeset in params and use it in create/update context methods
      # TODO: return tuple
      ...
      # TODO: accept paginator optional
